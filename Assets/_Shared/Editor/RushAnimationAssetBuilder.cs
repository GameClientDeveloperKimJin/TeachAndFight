...
{
    public static class RushAnimationAssetBuilder
    {
        private const string Root = "Assets/_Shared/Art/Characters/Rush";
        ...
        {
            new("Idle", "idle", "Rush_Idle", true),
            new("Move", "move", "Rush_Move", true),
            new("Dash", "dash", "Rush_Dash", false),
            new("AttackLight", "attack_light", "Rush_Attack_Light", false),
            new("AttackHeavy", "attack_heavy", "Rush_Attack_Heavy", false),
            new("AttackUltimate", "attack_ultimate", "Rush_Attack_Ultimate", false),
            new("HitStun", "hitstun", "Rush_HitStun", false),
            new("Down", "down", "Rush_Down", false),
        };

        [MenuItem("TeachAndFight/Art/Build Rush Animations")]
        public static void BuildRushAnimations()
        {
            ...
            Debug.Log("Rush animation clips and preview controller generated.");
        }

        [MenuItem("TeachAndFight/Art/Verify Rush Animations")]
        public static void BuildAndVerifyRushAnimations()
        {
            BuildRushAnimations();
            VerifyClips();
            Debug.Log("Rush animation verification passed.");
        }
        ...
        private static bool IsFramePath(string assetPath, string filePrefix)
        {
            ...
            var expectedPrefix = $"rush_{filePrefix}_";
        ...
        {
            var controllerPath = $"{Root}/RushPreview.controller";
        ...
        {
            var go = new GameObject("RushAnimationVerification");
