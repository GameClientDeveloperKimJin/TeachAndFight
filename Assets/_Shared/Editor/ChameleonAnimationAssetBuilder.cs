...
{
    public static class ChameleonAnimationAssetBuilder
    {
        private const string Root = "Assets/_Shared/Art/Characters/Chameleon";
        ...
        {
            new("Idle", "idle", "Chameleon_Idle", true),
            new("Move", "move", "Chameleon_Move", true),
            new("Dash", "dash", "Chameleon_Dash", false),
            new("AttackLight", "attack_light", "Chameleon_Attack_Light", false),
            new("AttackHeavy", "attack_heavy", "Chameleon_Attack_Heavy", false),
            new("AttackUltimate", "attack_ultimate", "Chameleon_Attack_Ultimate", false),
            new("HitStun", "hitstun", "Chameleon_HitStun", false),
            new("Down", "down", "Chameleon_Down", false),
        };

        [MenuItem("TeachAndFight/Art/Build Chameleon Animations")]
        public static void BuildChameleonAnimations()
        {
            ...
            Debug.Log("Chameleon animation clips and preview controller generated.");
        }

        [MenuItem("TeachAndFight/Art/Verify Chameleon Animations")]
        public static void BuildAndVerifyChameleonAnimations()
        {
            BuildChameleonAnimations();
            VerifyClips();
            Debug.Log("Chameleon animation verification passed.");
        }
        ...
        private static bool IsFramePath(string assetPath, string filePrefix)
        {
            ...
            var expectedPrefix = $"chameleon_{filePrefix}_";
        ...
        {
            var controllerPath = $"{Root}/ChameleonPreview.controller";
        ...
        {
            var go = new GameObject("ChameleonAnimationVerification");
