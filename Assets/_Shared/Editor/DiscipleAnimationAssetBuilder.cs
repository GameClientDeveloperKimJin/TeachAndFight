...
{
    public static class DiscipleAnimationAssetBuilder
    {
        private const string Root = "Assets/_Shared/Art/Characters/Disciple";
        ...
        {
            new("Idle", "idle", "Disciple_Idle", true),
            new("Move", "move", "Disciple_Move", true),
            new("Dash", "dash", "Disciple_Dash", false),
            new("AttackLight", "attack_light", "Disciple_Attack_Light", false),
            new("AttackHeavy", "attack_heavy", "Disciple_Attack_Heavy", false),
            new("AttackUltimate", "attack_ultimate", "Disciple_Attack_Ultimate", false),
            new("HitStun", "hitstun", "Disciple_HitStun", false),
            new("Down", "down", "Disciple_Down", false),
        };

        [MenuItem("TeachAndFight/Art/Build Disciple Animations")]
        public static void BuildDiscipleAnimations()
        {
            ...
            Debug.Log("Disciple animation clips and preview controller generated.");
        }

        [MenuItem("TeachAndFight/Art/Verify Disciple Animations")]
        public static void BuildAndVerifyDiscipleAnimations()
        {
            BuildDiscipleAnimations();
            VerifyClips();
            Debug.Log("Disciple animation verification passed.");
        }
        ...
        private static bool IsFramePath(string assetPath, string filePrefix)
        {
            ...
            var expectedPrefix = $"disciple_{filePrefix}_";
        ...
        {
            var controllerPath = $"{Root}/DisciplePreview.controller";
        ...
        {
            var go = new GameObject("DiscipleAnimationVerification");
