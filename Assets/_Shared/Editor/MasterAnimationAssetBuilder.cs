...
{
    public static class MasterAnimationAssetBuilder
    {
        private const string Root = "Assets/_Shared/Art/Characters/Master";
        ...
        {
            new("Idle", "idle", "Master_Idle", true),
            new("Move", "move", "Master_Move", true),
            new("Dash", "dash", "Master_Dash", false),
            new("AttackLight", "attack_light", "Master_Attack_Light", false),
            new("AttackHeavy", "attack_heavy", "Master_Attack_Heavy", false),
            new("AttackUltimate", "attack_ultimate", "Master_Attack_Ultimate", false),
            new("HitStun", "hitstun", "Master_HitStun", false),
            new("Down", "down", "Master_Down", false),
        };

        [MenuItem("TeachAndFight/Art/Build Master Animations")]
        public static void BuildMasterAnimations()
        {
            ...
            Debug.Log("Master animation clips and preview controller generated.");
        }

        [MenuItem("TeachAndFight/Art/Verify Master Animations")]
        public static void BuildAndVerifyMasterAnimations()
        {
            BuildMasterAnimations();
            VerifyClips();
            Debug.Log("Master animation verification passed.");
        }
        ...
        private static bool IsFramePath(string assetPath, string filePrefix)
        {
            ...
            var expectedPrefix = $"master_{filePrefix}_";
        ...
        {
            var controllerPath = $"{Root}/MasterPreview.controller";
        ...
        {
            var go = new GameObject("MasterAnimationVerification");
